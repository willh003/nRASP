...
Function getCurrentData()
	...
	ht_true = lith_ht  + (KVAL * lith_defl)			// Compare to actual slope to get scaled height 
end
...
Function scaleForce(ht_to_dig)
	...
	NVAR VMAX = dfr:VMAX, VTHRESHOLD = dfr:VTHRESHOLD, DIGPFR = dfr:DIGPFR, VSP = dfr:VSP
...
Function NanoRASP_Panel() : Panel
	...
	CheckBox IncludeDef1,pos={190,117},size={173,14},title="Check to not increment img_num"
	CheckBox IncludeDef1,value= 0
